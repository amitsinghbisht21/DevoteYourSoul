...
export const blogPosts: BlogPost[] = [
  {
    id: "1",
    title: "When You Feel Lost — Read This",
  ...
  {
    id: "3",
    title: "Signs the Universe Is Guiding You",
  ...
  {
    id: "4",
    title: "You Are Not What Happens to You",
  ...
  {
    id: "5",
    title: "Do Your Karma, Leave the Rest",
...
// IMAGE
  ...
  {
    id: "6",
    title: "The Power of Calm in Chaos",
    slug: "the-power-of-calm-in-chaos",
    excerpt:
      "Calmness in crisis is a trained response. Learn breath-based and attention practices that regulate your nervous system and let you act with clarity under pressure.",
    content: `Calmness is not an accident; it is a habit cultivated by repeated, small choices. In the Bhagavad Gita, Krishna counsels steadiness in the face of turmoil — not to withdraw, but to act from a clear mind. Modern research in psychophysiology supports this: when the nervous system is regulated, cognitive function and decision-making improve.

// IMAGE: /assets/blog-images/the-power-of-calm-in-chaos.svg

## Quick Practices to Shift State

### 1) Breathing Patterns
Use a simple coherent-breath pattern: inhale for 4, hold 1, exhale for 6. Three cycles can downregulate the stress response.

### 2) The Pause-and-Name Technique
Pause for a breath and label the dominant emotion. Naming reduces amygdala activity and increases prefrontal regulation.

### 3) Micro-rituals
Create a short transition ritual between tasks (e.g., a bell tone or a single breath) to reset attention and reduce task carryover stress.

## Example

During a high-stakes period, one leader I worked with used the breath technique before key meetings. The shift was noticeable: calmer tone, clearer decisions, and fewer impulsive reactions.

## About the Author

I teach nervous-system-informed practices rooted in contemplative traditions. My approach aims to be accessible and effective in everyday stressful situations.

## Final Note

When we practice calm in small moments, it accumulates into a resilient capacity that shows up when it matters most.
`,
    category: "Mindfulness",
    date: "Oct 9, 2025",
    image: "/assets/blog-images/the-power-of-calm-in-chaos.webp",
  },

  {
    id: "7",
    title: "Detach, but Stay Kind",
    slug: "detach-but-stay-kind",
    excerpt:
      "Healthy detachment keeps the heart open while preventing codependence. Learn how compassion and clear boundaries create sustainable, loving relationships.",
    content: `Detachment is often misunderstood as emotional coldness. True detachment is a mature, compassionate stance: you care deeply but don't make another's path your identity. This balance reduces suffering for you and others.

// IMAGE: /assets/blog-images/detach-but-stay-kind.svg

## Detachment vs. Disconnection

Detachment preserves compassion and responsibility without slipping into enmeshment. The practice is to witness with care while allowing space for autonomy.

### Concrete Steps
- Identify your limits and communicate them calmly.
- Practice self-soothing when triggered instead of reacting.
- Offer help without expecting a particular outcome.

## A Real Example

Someone I coached would rescue friends to avoid discomfort. Over time she learned to set a simple boundary: offer support and a next-step suggestion, but step back if the other person didn’t use it. The relationship became healthier and more reciprocal.

## About the Author

I guide people through relational clarity, integrating contemplative practices with communication skills.

## Closing Reflection

Detachment with kindness is liberating: it preserves your energy and honors the other’s freedom.
`,
    category: "Self-Awareness",
    date: "Oct 9, 2025",
    image: "/assets/blog-images/detach-but-stay-kind.webp",
  },

  {
    id: "8",
    title: "The Inner Battle",
    slug: "the-inner-battle",
    excerpt:
      "The inner battle is fought in attention. Learn how steady practices—meditation, journaling, and skillful action—help you shift from reactivity to wise responding.",
    content: `The metaphor of Kurukshetra—the battlefield in the Bhagavad Gita—maps the struggles we carry within ourselves: fear, distraction, attachment, and aversion. The task is not to wage war against parts of ourselves but to cultivate leadership of the mind through consistent practice.

// IMAGE: /assets/blog-images/the-inner-battle.svg

## Why the Inner Battle Matters

We often mistake external conflict for the main problem when the deeper issue is the habitual patterns in our minds. When those patterns govern our choices, we act from reactivity rather than wisdom.

## Practices to Train the Mind

### Daily Meditation
Short, regular sessions strengthen attention and increase the space between stimulus and response.

### Reflection and Journaling
Use questions like: "What triggered me today?" and "What choice did I make?" This builds self-knowledge and redirects behavior.

// IMAGE: /assets/blog-images/the-inner-battle.jpg

### Small, Intentional Experiments
Test new responses in low-stakes situations. Over time, these experiments reshape habit.

## About the Author

My teaching blends long-term contemplative practice with actionable daily methods to help people transform inner turbulence into steady presence.

## Closing Practice

Pick one 5-minute practice today—breath, journaling, or a brief walk—and notice how a small, steady habit begins to change the landscape of your inner life.
`,
    category: "Spiritual Awakening",
    date: "Oct 10, 2025",
    image: "/assets/blog-images/the-inner-battle.webp",
  },
